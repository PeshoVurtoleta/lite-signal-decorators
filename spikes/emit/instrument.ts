...
(globalThis as any).__EMIT_LOG = LOG;
...
export function mark(tag: string) {
  return function (value: any, ctx: any) {
    ...
    if (!(globalThis as any).__STANDARD_ARGS) {
      (globalThis as any).__STANDARD_ARGS = {
...
export function replaceClass(value: any, ctx: any) {
...
export function legacyShapeProbe(...args: any[]) {
