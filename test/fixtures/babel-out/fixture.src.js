var _Base2;
let _initProto, _initClass, _init_count, _init_extra_count, _init_level, _init_extra_level, _init_computedKey, _init_extra_computedKey, _initProto2, _initClass2, _init_a, _init_extra_a, _initProto3, _initClass3, _init_b, _init_extra_b, _initClass4, _init_src, _init_extra_src, _draftDecs, _init_draft, _init_extra_draft, _mirrorDecs, _init_mirror, _init_extra_mirror;
...
class Locals {
  static {
    ({
      e: [_init_src, _init_extra_src, _init_draft, _init_extra_draft, _init_mirror, _init_extra_mirror],
      c: [_Locals, _initClass4]
    } = _applyDecs(this, [reactiveHost], [[reactive, 1, "src"], [_draftDecs, 1, "draft"], [_mirrorDecs, 1, "mirror"]]));
  }
  constructor() {
    _init_extra_mirror(this);
  }
  #A = _init_src(this, 10);
  get [(_draftDecs = localTo(self => self.src), _mirrorDecs = localTo(self => self.src), "src")]() {
    return this.#A;
  }
  set src(v) {
    this.#A = v;
  }
  #B = (_init_extra_src(this), _init_draft(this, 0));
  get draft() {
    return this.#B;
  }
  set draft(v) {
  ...
  #C = (_init_extra_draft(this), _init_mirror(this));
  get mirror() {
    return this.#C;
  }
  set mirror(v) {
